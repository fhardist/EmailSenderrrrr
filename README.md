...
5. Salin **16 digit huruf acak** yang muncul (Contoh: `ayur tfql wqkd vzac`). Simpan kode ini ke Notepad!
...
*   `CV Fatkhul Hardist Nur Fauzan.pdf` -> File PDF CV kamu yang akan otomatis terlampir.
...
| 3 | `termux-setup-storage` | Beri izin akses memori internal |
| 4 | `git clone https://github.com/USERNAME_LU/EmailSender.git` | Download repositori dari GitHub |
| 5 | `cd EmailSender` | Masuk ke folder project |
| 6 | `cp "/sdcard/Download/CV Fatkhul Hardist Nur Fauzan.pdf" ./` | Salin file CV dari folder Download HP |
...
<table>
  ...
  <tr>
    <td><b>2. Pindahkan Berkas PDF</b></td>
    <td><pre>termux-setup-storage && cp "/sdcard/Download/CV Fatkhul Hardist Nur Fauzan.pdf" ~/EmailSender/</pre></td>
  </tr>
  <tr>
    <td><b>3. Setup Script & System (Otomatis)</b></td>
    <td>
      <pre>
...
EMAIL_PENGIRIM = "fatkhulhardist354@gmail.com"
EMAIL_PASSWORD = "ayur tfql wqkd vzac"
FILE_TEXT = "body.txt"
FILE_LAMPIRAN = "CV Fatkhul Hardist Nur Fauzan.pdf"
...
EOF
  ...
  <tr>
    <td><b>4. Pasang Shortcut Global Terminal</b></td>
    <td>
      <pre>
...
Setelah instalasi selesai (menggunakan Jalur A ataupun Jalur B), kamu bisa langsung mengirim email kapan pun tanpa perlu mengetik kata perintah pembuka. Cukup gunakan struktur berikut:

```bash
fhardist@gmail.com , Lamaran Pekerjaan IT Support Berkas Final Tanpa Petik
