...
# ==================== KONFIGURASI UTAMA ====================
EMAIL_PENGIRIM = "your_email@gmail.com"    # Ubah jadi email Gmail milikmu
EMAIL_PASSWORD = "xxxx xxxx xxxx xxxx"     # Masukkan 16 digit App Password tanpa spasi jika bermasalah
FILE_TEXT = "body.txt"                     # Nama file pesan template kamu
FILE_LAMPIRAN = "CV_Kamu.pdf"              # Sesuaikan dengan nama file PDF asli kamu yang di dalam berkas
# ===========================================================
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Format Penggunaan termux: python bot_termux.py [email_tujuan] , [Subjek Bebas Tanpa Petik]")
    else:
